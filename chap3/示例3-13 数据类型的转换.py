...
print(z,type(z)) # 隐式转换，通过运算隐式的地转换了数据类型
...
print('十进制转成十六进制:',hex(26472))# 转换之后的结果是字符串类型
print('十进制转成八进制:',oct(26472))# 转换之后的结果是字符串类型
print('十进制转成二进制:',bin(26472))# 转换之后的结果是字符串类型
